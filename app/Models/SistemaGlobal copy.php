...
class SistemaGlobal extends Model
{
    ...
    public static $paginaSolo = [
        [
            ...
            "apresentacao" => "Confira os principais dados obtidos por meio da análise de solo.",
            "dadosAnalise" => [] // Add an empty array to store the soil analysis data
        ]
    ];

    public static function loadAnaliseSoloData()
    {
        $soloController = new SoloController();
        $analiseSoloData = $soloController->getAnaliseSoloData();
        self::$paginaSolo[0]['dadosAnalise'] = $analiseSoloData;
    }
